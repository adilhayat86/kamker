...
export const categoryAliases: Record<string, string[]> = {
  ...
  Drivers: ["taxi driver", "cab driver", "van driver", "car driver", "chauffeur"],
  "Truck Drivers": ["truck driver", "dump truck driver", "tractor trailer driver"],
  "Bus Drivers": ["bus driver"],
  "Delivery Riders": ["courier boy", "delivery boy", "parcel delivery", "rider", "postman", "dakia"],
  ...
  Maids: ["domestic worker", "maid", "home maid"],
  Housekeepers: ["house keeper", "housekeeping attendant"],
  Cleaners: ["floor cleaner", "window cleaner", "sofa cleaner", "carpet cleaner", "tank cleaner", "dry cleaner"],
  ...
  "Car Mechanics": ["auto mechanic", "automotive mechanic", "car mechanic", "motor mechanic", "brake specialist", "alignment technician"],
